...
public class GeoTiffImportResult
{
    ...
    /// <summary>
    /// The geographic bounding box in WGS84 (EPSG:4326) coordinates.
    /// This is the bounding box to use for Overpass API queries.
    /// May be null if the GeoTIFF has no projection info or transformation failed.
    /// If the source GeoTIFF is already in WGS84, this will be the same as BoundingBox.
    /// </summary>
