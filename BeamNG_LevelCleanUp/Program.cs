...
internal class Program6
{
    ...
    private static void Main()
    {
        ...
        var programStart = p.StartAsync(cancelSource.Token);
    ...
    private static void p_ExitRequested(object sender, EventArgs e)
    {
        StaticVariables.ApplicationExitRequest = true;
