...
public class MaterialJson
{
    ...
    [JsonIgnore] public List<MaterialFile> MaterialFiles { get; set; } = new();

    [JsonIgnore] public bool NotUsed { get; set; }

    [JsonIgnore] public bool IsDuplicate { get; set; }

    [JsonIgnore] public int DuplicateCounter { get; set; } = 1;

    [JsonIgnore] public List<string> DuplicateFoundLocation { get; set; } = new();

    [JsonIgnore] public string MatJsonFileLocation { get; set; }
