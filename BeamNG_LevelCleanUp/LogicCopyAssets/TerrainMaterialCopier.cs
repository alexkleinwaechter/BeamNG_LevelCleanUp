...
public class TerrainMaterialCopier
{
    ...
    public TerrainMaterialCopier(PathConverter pathConverter, FileCopyHandler fileCopyHandler, string levelNameCopyFrom,
        GroundCoverCopier groundCoverCopier, string levelPathCopyFrom)
    ...
    public TerrainMaterialCopier(PathConverter pathConverter, FileCopyHandler fileCopyHandler, string levelNameCopyFrom,
        GroundCoverCopier groundCoverCopier, string levelPathCopyFrom, string targetLevelPath)
    ...
    public bool Copy(CopyAsset item)
    {
        ...
        if (_groundCoverCopier != null) _groundCoverCopier.CollectGroundCoversForTerrainMaterials(item.Materials);
        ...
        int roughnessValue = 150)
    {
        try
        {
            ...
            if (materialObj == null) return true;
    ...
    private void UpdateTerrainMaterialMetadata(JsonNode materialObj, string newName, string newInternalName,
        string newGuid)
    {
        materialObj["name"] = newName;

        if (materialObj["internalName"] != null) materialObj["internalName"] = newInternalName;
